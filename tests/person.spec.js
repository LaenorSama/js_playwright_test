...
test('Ручной тест @allure.manual:true @allure.id:529', async () => {
...
test.describe('Запуск ручного теста', () => {
  test('Запуск ручного теста', async ({}) => {
    ...
    allure.step('Запуск ручного теста', () => {
      // Здесь можно добавить логику теста или оставить пустым для ручного тестирования
    });
  });
});
